...
import shopcarrinho.R
import shopcarrinho.databinding.ActivitySampleBinding
import java.io.Serializable

class SampleActivity : AppCompatActivity(), ShopAnalytics, ShopDesignSystem, ShopNetwork, ShopNavigate, ShopCache, HomeCallback {
    ...
    private fun startModule() {
        val dependencies = HomeModuleDependencies(
            this,
            this,
            this,
            this,
    ...
    override suspend fun postNetwork(url: String, params: Any, responseClass: Any): Any {
        return HomeResponse("123456789", "test", "10/10")
    }
